...
def runPing():
    ...
    try:
        ...
        while True:
            ...
            TotalCheck = 0
            checkWriteFile = 0
            length_of_sites = len(IPAddresses)
            startPingTime = []
            endPingTime = []
            ### Declar params
            Sum_CellName = []
            ...
            for ip in IPAddresses:
                ...
                os.system('cls')
                print("************************************************")
                print(f"BSC-IP: {bscIP}")
                print(f"CellName: {CellNames[i]}, STATUS: {List_STATUS[i]}")
                print(f"TOTAL OF PACKET-LOSS: {len(Sum_CellName)} {msgCellName}")
